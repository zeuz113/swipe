...
//	//console.log(fingerData[1].end)	
		...
		*/
		...
		function calculateAngle2(startPoint, endPoint) {
			var x = startPoint.x - endPoint.x;
			var y = endPoint.y - startPoint.y;
			var r = Math.atan2(y, x); //radians
			var angle = Math.round(r * 180 / Math.PI); //degrees
...
//	
//console.log("y inicia dedo1 "+data[0].start.y)
//console.log("y termina dedo1"+data[0].end.y)
//
//
//console.log("y inicia dedo 2 "+data[1].start.y)
//console.log("y termina dedo 2"+data[1].end.y)
	...
	//$('#xdatos').html("x inicia "+data[0].start.x+"x termina "+data[0].end.x)
	//$('#xdatos').html("fingerData "+fingerData+ " x inicia dedo 2 "+fingerData[1].start.x+"x termina dedo 2 "+fingerData[1].end.x)
...
//	difVertical=datovertical2-datovertical
	...
	//$('#finger2Sw').html('inicia dedo 2 '+data[1].start.y+"     "+data[1].end.y)
...
//	
//	
//	$('#finger2Sw').html('inicia dedo '+fingerData[0].start.X+"     "+fingerData[0].end.X)
//	$('#ydatos').html("y inicia "+data[0].start.y+"y termina "+data[0].end.y)
//	$('#xdatos').html("x inicia "+data[0].start.x+"x termina "+data[0].end.x)
//	
//	console.log("start 0")
